...
class DistMult(Module):
    """ DistMult similarity scoring function for Link Prediction (from https://arxiv.org/pdf/1412.6575.pdf) """
    def __init__(self,
                 indim,
                 outdim,
                 num_nodes,
    ...
    def initialise_parameters(self):
        ...
        Options for initialising weights include:
            ...
            (default) schlichtkrull-normal - schlichtkrull initialisation using a normal distribution
