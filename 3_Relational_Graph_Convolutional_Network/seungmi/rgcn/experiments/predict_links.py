...
sys.path.append(os.path.dirname(os.path.abspath("/home/mee0520/GNN_study/RGCN/torch-rgcn/utils")))
...
def train(dataset,
    ...
    eval_every = evaluation["check_every"] if "check_every" in evaluation else 50
