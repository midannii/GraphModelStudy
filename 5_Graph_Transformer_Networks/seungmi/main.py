...
# from torch_geometric.utils.metric import f1_score
...
if __name__ == '__main__':
    ...
    with open('/home/mee0520/GNN_study/GTN/data/%s/node_features.pkl' % args.dataset,'rb') as f:
        node_features = pickle.load(f)
    with open('/home/mee0520/GNN_study/GTN/data/%s/edges.pkl' % args.dataset,'rb') as f:
        edges = pickle.load(f)
    with open('/home/mee0520/GNN_study/GTN/data/%s/labels.pkl' % args.dataset,'rb') as f:
        labels = pickle.load(f)
    if args.dataset == 'PPI':
        with open('/home/mee0520/GNN_study/GTN/data/%s/ppi_tvt_nids.pkl' % args.dataset, 'rb') as fp:
            nids = pickle.load(fp)
